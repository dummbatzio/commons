...
<template>
    <Container>
        ...
        <TaskDataTable :tasks="tasks" :total="totalTasks" @edit="onEdit" @copy="onCopy" @refresh="refresh" />
    </Container>
    <TaskEditDialog :open="dialogData.open" :task="dialogData.task" @close="onClose" @success="onSuccess" />
</template>
